...
class Expand(QTabWidget):
    ...
    def setupUi(self):
        ...
        self.pushButton_initParam_folder.clicked.connect\
            (lambda: browse.browseFolderSlot(self.lineEdit_initParam_folder)) 
        self.pushButton_recon_folder.clicked.connect\
            (lambda: browse.browseFolderSlot(self.lineEdit_recon_folder)) 
        ...
        self.pushButton_mask.clicked.connect\
            (lambda: browse.browseSlot(self.lineEdit_mask, 'map')) 
        
        self.pushButton_star_file_to_use.clicked.connect\
            (lambda: browse.browseSlot(self.lineEdit_star_file_to_use, 'star')) 
        self.pushButton_pick_param_file_to_use.clicked.connect\
            (lambda: browse.browseSlot(self.lineEdit_pick_param_file_to_use, 'params')) 
        self.pushButton_expand_folder_to_use.clicked.connect\
            (lambda: browse.browseFolderSlot(self.lineEdit_expand_folder_to_use)) 
    ...
    def retranslateUi_tab1(self):
        ...
        self.label_expand_folder.setText(_translate("Form", "Expand Folder:"))
    ...
    def setUI_tab1(self):
        ...
        self.horizontalLayout_4.addWidget(self.lineEdit_expand_folder)
